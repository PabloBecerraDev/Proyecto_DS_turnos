...
const PersonalData = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-[80vh] bg-gray-100 px-6 py-10">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-md p-8">
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="flex flex-col w-full sm:w-[45%] min-w-[200px]">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 shadow-sm text-gray-800">
              {user?.codigo ?? "Cargando..."}
            </div>
          </div>

          <div className="flex flex-col w-full sm:w-[45%] min-w-[200px]">
            <label className="text-gray-600 font-semibold mb-2">Prioridad:</label>
            <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 shadow-sm text-gray-800">
              {user?.prioridad ?? "Sin prioridad"}
            </div>
          </div>
...
//           <div style={styles.fieldValue}>{'Cargando...'}</div>
//         </div>
...
//           <div style={styles.fieldValue}>{ 'Sin prioridad'}</div>
//         </div>
